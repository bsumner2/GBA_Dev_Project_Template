...
#define SERIAL_RCNT_INIT do REG_SERIAL_RCNT &= 0x000F; while (0)

#define SERIAL_BAUD_FLAG_9600   0
#define SERIAL_BAUD_FLAG_38400  1
#define SERIAL_BAUD_FLAG_57600  2
#define SERIAL_BAUD_FLAG_115200 3

#define SERIAL_MP_PAD0_REQUIRED_VALUE 0x20
#define SERIAL_NORM_PAD1_REQUIRED_VALUE 0
#define SERIAL_NORM_PAD2_REQUIRED_VALUE 0
#define SERIAL_UART_PAD0_REQUIRED_VALUE 3
